          ...
          <div class="tab-inner-warp">
            <div class="tab-inner">
              <article class="question question-type-norm">
                <h2>
                  <a href="single_question_poll.html">This Is My First Normal Question</a>
                </h2>
                <a class="question-report" href="#">MTH101</a>
                ...
                <div class="question-inner">
                  ...
                  <span class="question-date"><i class="icon-heart"></i>Favourite</span>
              ...
              <article class="question question-type-norm">
                ...
                <!-- vote value -->
                <div class="number-vote"><input type="number" id="number-vote" value="4" readonly/></div>
                <!-- end of vote value -->
                <!-- vote down -->
                <div class="vote-down">
                  <div original-title="This answer is not useful" class="question-author-vote-down tooltip-s" value="Decrease Value" onClick="decreaseValue()"><span></span><div id="decrease"></div></div>
              ...
              </article><article class="question question-type-norm">
                <h2>
                  <a href="single_question_poll.html">This Is My First Normal Question</a>
                </h2>
                <a class="question-report" href="#">MTH101</a>
